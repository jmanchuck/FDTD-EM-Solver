...
simulation_size = 4
simulation_time = 2 * simulation_size / C
...
solver.set_reflect_square((0, 1), (1.72, 1.05))
solver.set_reflect_square((1.76, 1), (2.24, 1.05))
solver.set_reflect_square((2.28, 1), (simulation_size, 1.05))
solver.set_reflect_boundaries(up=False, down=False, left=False, right=False)

solver.save("large_double_slit")
